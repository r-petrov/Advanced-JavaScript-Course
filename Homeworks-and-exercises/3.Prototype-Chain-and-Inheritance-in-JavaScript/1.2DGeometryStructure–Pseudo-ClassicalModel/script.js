...
var pointA = new Point('A', 8, 9);
var pointB = new Point('B', 4, 9);
var pointC = new Point('C', 8, 7);

var circle = new Shapes.circle(pointO, 4.5, 'violet');
var rectangle = new Shapes.rectangle(pointO, 7, 8, 'red');
var triangle = new Shapes.triangle(pointA, pointB, pointC, 'green');
var line = new Shapes.line(pointA, pointB, '#ffffff');
var segment = new Shapes.segment(pointA, pointC, '#ffffff');
